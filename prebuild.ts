...
async function buildApiDocs(): Promise<void> {
  ...
  const dll =
    '../docusaurus-artifacts/artifacts/bin/Riok.Mapperly.Abstractions/debug/Riok.Mapperly.Abstractions.dll';
...
async function buildAnalyzerRulesData(): Promise<void> {
  ...
  const sourceFile = '../docusaurus-artifacts/src/Riok.Mapperly/AnalyzerReleases.Shipped.md';
...
async function buildSamples(): Promise<void> {
  ...
  const generatedMapperFile =
    '../docusaurus-artifacts/artifacts/obj/Riok.Mapperly.Sample/debug/generated/Riok.Mapperly/Riok.Mapperly.MapperGenerator/CarMapper.g.cs';
  await copyFile(generatedMapperFile, join(targetDir, 'CarMapper.g.cs'));

  // Copy sample project files to target dir
  const sampleProject = '../docusaurus-artifacts/samples/Riok.Mapperly.Sample';
